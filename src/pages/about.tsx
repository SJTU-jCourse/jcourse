...
const About = () => {
  return (
    <Card title="常见问题（FAQ）">
      ...
      <Title level={3}>我该点评哪些课程？写一些什么？</Title>
      <Paragraph>
      ...
      <Title level={3}>我喜欢看1-5评分的数据，不喜欢看字。</Title>
      <p>
      ...
      <Title level={3}>请特别注意：&quot;数据&quot;会给人错误的信心</Title>
      <p>
      ...
      <Divider></Divider>
      <Title level={2}>基本原则</Title>
      <Title level={3}>本站由谁来管理？</Title>
      <p>
      ...
      <Title level={3}>我会因为在这里发表信息而被约谈吗？</Title>
      <p>
      ...
      <Title level={3}>网站上的内容是否受管理？</Title>
      <p>
      ...
      <Title level={3}>网站上的内容版权问题如何界定？</Title>
      <p>
      ...
      <Divider></Divider>
      <Title level={2}>其他事项</Title>
      <Title level={3}>如何联系你们？</Title>
      <p>
        请通过<Link to="/report">这个链接</Link>
        向平台提出意见和建议，如果希望得到私下的回复， 请留下你的联系方式。
      </p>
      <Title level={3}>我是课程老师…</Title>
      <ul>
        <li>
