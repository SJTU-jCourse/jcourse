  ...
  return (
    <PageHeader title="常见问题" onBack={() => history.goBack()}>
      <Card>
        ...
        <Paragraph>
          这不是本站的主题。我们希望的是提供完全信息，方便同学们了解这门课的风格，工作量与历史。不是哪些课容易满绩。
          <br />
        ...
        <Paragraph>
          原则上我们不修改内容，只修正事实性错误，如：拼写错误的老师姓名、错误的课程名称、学期、成绩格式等。
        </Paragraph>
