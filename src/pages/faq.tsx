  ...
  return (
    <PageHeader title="常见问题" onBack={() => history.goBack()}>
      <Card>
        ...
        <Paragraph>
          这不是本站的主题。我们希望的是提供完全信息，方便同学们了解这门课的风格，考核标准与历史。不是哪些课容易满绩。
          <br />
        ...
        <Paragraph>
          ...
          <br />
          文字可以透露实质的信息，比如&quot;这门课大作业是帮着老师实验室做项目&quot;，但是给分极好，按1-5评分，可能这门课能登水课榜首，但这也会坑很多人。
          <br />
        ...
        <Title level={4}>我会因为在这里发表信息而被约谈吗？</Title>
        <Paragraph>
          尽管我们使用 jAccount
        ...
        <Paragraph>
          这不意味着我们完全不管理本站内容。我们不希望列举过多的规则
          ，但以下内容本社区不予接受：
          <ul>
            <li>非课程点评信息。</li>
            <li>
              伪装成&quot;课程点评&quot;，实质对他人利益侵害的信息。比如：
              暴露没有必要的人物隐私、与课程内容无关的诽谤和人身攻击。
        ...
        <Paragraph>
          向本站提交点评时，您同意向本站提供对您提交的点评内容的永久、不可撤回、非独占、
          全球有效无限制的许可。 您依然享有您提交的内容的全部版权。
        </Paragraph>
        <Paragraph>
          任何人（除了原始所有权人）不得在未经本站许可的条件下，转载本站内容
          （包括全部或部分内容）。
        </Paragraph>
        <Paragraph>
